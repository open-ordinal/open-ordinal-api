[Open Ordial API](../README.md) / OOAPI
...
- [getAsset](functions/getAsset.md)
...
- [getComposition](functions/getComposition.md)
...
- [setType](functions/setType.md)
- [getType](functions/getType.md)
- [setMetadata](functions/setMetadata.md)
- [getRequestParams](functions/getRequestParams.md)
- [getMetadata](functions/getMetadata.md)
- [getInscription](functions/getInscription.md)
- [getSatAt](functions/getSatAt.md)
- [getSatPage](functions/getSatPage.md)
- [getSatAll](functions/getSatAll.md)
- [getParentsPage](functions/getParentsPage.md)
...
- [getBlockHeight](functions/getBlockHeight.md)
- [getBlockTime](functions/getBlockTime.md)
- [getLatestId](functions/getLatestId.md)
- [getLatestPath](functions/getLatestPath.md)
- [isOrdinalAPIExtensionsAvailable](functions/isOrdinalAPIExtensionsAvailable.md)
- [getOrdinalApiFromIFrame](functions/getOrdinalApiFromIFrame.md)
...
- [getTrait](functions/getTrait.md)
...
- [getVariant](functions/getVariant.md)
- [getVariants](functions/getVariants.md)
- [clearVariants](functions/clearVariants.md)
- [setDisplayedVariant](functions/setDisplayedVariant.md)
- [getDisplayedVariant](functions/getDisplayedVariant.md)
