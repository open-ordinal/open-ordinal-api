...
1. **[Structure of Collection](guides/1_Collection_Structure.md)**  
   Learn about the parent-child structure of collections and how to define relationships between ordinals.
   - [Ordinal Structure](guides/1_Collection_Structure.md#ordinal-structure)
   - [Simple Example](guides/1_Collection_Structure.md#simple-example)
   - [Advanced Example](guides/1_Collection_Structure.md#advanced-example)
   - [Parent Example](guides/1_Collection_Structure.md#parent-example)

2. **[General Concepts](guides/2_General.md)**  
   Explore general ideas and best practices for creating ordinal collections, including lazy loading and using recipes.
   - [Lazy Loading](guides/2_General.md#lazy-loading)
   - [Using Recipes](guides/2_General.md#use-a-recipe-to-define-the-ordinal-in-the-collection)

3. **[Setup of Ordinal Collection](guides/3_ooAPI_Setup.md)**  
   Understand the setup process for ordinal collections, including how to structure HTML files and call common setup code.
   - [Setup Process](guides/3_ooAPI_Setup.md)  
     Learn the essential steps to configure your environment and prepare for collection setup.
   - [Example Ordinal Collection Child](guides/3_ooAPI_Setup.md#example-ordinal-collection-item)  
     Explore a practical example of an ordinal collection child to see how it fits into the overall structure.
   - [Common Setup Code](guides/3_ooAPI_Setup.md#common-setup-code)  
     Review frequently used code snippets that facilitate the setup of your ordinal collections.

4. **[Interacting With Open Ordinal API](guides/4_Interacting_With_ooAPI.md)**  
   Conclude your journey through the guide with insights on interacting with your collection.
   - [API Overview](guides/4_Interacting_With_ooAPI.md#api-overview)  
     Understand the basic concepts and functionalities of the Open Ordinal API.
   - [Consuming the API](guides/4_Interacting_With_ooAPI.md#consuming-the-open-ordinal-api)  
     Learn how to make requests to the API and handle responses effectively.
   - [Conclusion](guides/4_Interacting_With_ooAPI.md#conclusion)
